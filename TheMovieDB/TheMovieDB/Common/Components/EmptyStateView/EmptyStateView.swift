...
class EmptyStateView: UIView {
    ...
    let imageView: UIImageView = {
        ...
        imageView.tintColor = TMDBColor.main900.color
    ...
    let subtitleLabel: UILabel = {
        ...
        label.textColor = TMDBColor.main100.color
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
    ...
    let button: UIButton = {
        ...
        button.backgroundColor = TMDBColor.main900.color
    ...
    private func setupSubviews() {
        backgroundColor = TMDBColor.main400.color
